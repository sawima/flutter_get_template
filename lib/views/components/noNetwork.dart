                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Column(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          Text("绑定设置终端设备",style: TextStyle(color: Colors.white,fontSize: 30),),
                          SizedBox(height: 10,),
                          Row(
                            mainAxisAlignment: MainAxisAlignment.center,
                            crossAxisAlignment: CrossAxisAlignment.center,
                            children: [
                              QRImageWidget(statementStr: "绑定设备",qrStr: "https://android.com",),
                              SizedBox(width: 40,),
                              QRImageWidget(statementStr: "配置无线网络",qrStr: "https://android.com",),
                            ],
                          )
                        ],
                      ),
                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            Column(
                              children: [
                                Padding(padding: EdgeInsets.only(right: 5),child: Text("网络连接状态",style: TextStyle(color: Colors.white,fontSize: 18),)),
                                SizedBox(height: 10,),
                                Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Text("无线网络(MyHomeWifi)",style: TextStyle(color: Colors.white,fontSize: 14),),
                                      Text("192.168.1.12",style: TextStyle(color: Colors.green,fontSize: 18),),
                                    ],
                                  ),
                                ),
